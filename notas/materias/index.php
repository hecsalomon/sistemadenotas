    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Listado de  <b>Materias</b></h2></div>
                    <div class="col-sm-4">
                        <a href="crear_Materia.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Agregar Materia</a>
                    </div>
                </div>
            </div>
